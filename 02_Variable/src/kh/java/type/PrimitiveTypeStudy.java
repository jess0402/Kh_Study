 ...
 * 	- 실수형 23.45		float (4byte)			소수점이하 7자리
 * 						double (8byte) - 기본형	소수점이하 16자리
 * 
 * 2. 참조형(클래스) 변수에 객체에 대한 주소값을 보관하는 타입
 *
 * 변수가 기본형일수도 있고 참조형일수도 있음 
 */
...
//		study.test2();
	 ...
	 * 	- 시계와 같은 원리 -> 23:59 다음엔 00:00이 되는 것과 같음.
	 */
	 ...
	 * 	- 항상 같은 값을 가지는 변수, 초기화 이후 값을 변경할 수 없는 변수
	 * 	- 반드시 초기화해야 한다.
	 */
...
//		MY_AGE = MY_AGE + 1; // 값변경 불가
	...
	public void test1() {
		...
		lnum = 12_345_689_012_345L;  // 이 값을 long 타입으로 명시
